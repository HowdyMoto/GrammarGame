...
tap *between* words to insert a missing comma or period. Three difficulty modes —
Easy shows counts per error type, Hard shows only the total, Master shows neither.
